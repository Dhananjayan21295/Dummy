...
<table border=0 style="width:100%;background-color:#1eb6e1;">
 ...
 <tr  >
  ...
  <td> <input type="date"  name="poissuedate" size="20" required >  </td>
  </tr>
 ...
 <tr  >
  ...
  <td> <input type="text"  name="status" size="20" required >   </td>
   ...
   <tr>
  <td> *Due Date</td>
  <td> <input type="date"  name="duedate" size="20" required >  </td>
  </tr>
...
<div id="containers" style="background-color:#afe9f5">
 ...
 <tr  >
  ...
  <tr>
  <td> Picup Start</td>
  <td> <input type="date"  name="search" size="40" required >  </td>
  </tr>
