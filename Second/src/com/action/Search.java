...
public class Search extends org.apache.struts.action.Action{
    ...
    private static String driver = "jdbc:mysql://localhost:3306/hi_db";
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            String query = "SELECT * FROM hi_db.purchaseorder WHERE ponumber='"+num+"'or seller='"+num+"'or status='"+num+"'or priority='"+num+"'";
